...
let convertToLarger = (num, conv) => num / conv;

let msToTotalSeconds = (mil, sec) => convertToLarger(mil,1000);
let msToTotalMinutes = (mil, min) => msToTotalSeconds(mil) / 60;
let msToTotalHours = (mil, hrs) => msToTotalMinutes(mil) / 60;
